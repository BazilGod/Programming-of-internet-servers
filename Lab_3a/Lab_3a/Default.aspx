...
<body>
    <form id="form1" runat="server">
        ...
        <input id="CheckBox1" name="RadioButton" title="RadioButton" type="radio" AutoPostBack="True" runat="server" value="RadioButton" onserverchange="RadioButton_OnServerChange"  /><br />
